...
const blogRoutes = [
  ['/resources/blogs/hire-through-conversation-action-ai-agent', 'AI ATS Action Agent for Conversational Recruitment | HireScoreAI', 'Learn how HireScoreAI’s AI ATS Action Agent supports conversational recruitment, from job creation and resume screening to candidate ranking, communication and interviews—with recruiter approval.', 'AI Recruitment Automation', `${SITE_URL}/action-ai-agent-conversation.webp`, '2026-07-26', '2026-08-02', 'BlogPosting'],
