...
function TechHiringProblem() {
  const pains = [[Files, 'Too many candidates to review'], [Target, 'Hard to identify actual role fit'], [CalendarCheck, 'Too many hiring tasks to coordinate']]
  return <section className="techStorySection techProblem"><div className="commandContainer"><div className="techSectionIntro"><span className="sectionKicker">The challenge</span><h2>Tech hiring gets messy fast.</h2><p>Candidate sourcing, resume review, interviews, follow-ups and decisions often happen across disconnected tools.</p></div><div className="techPainGrid">{pains.map(([Icon, text]) => <article key={text}><Icon size={20} /><span>{text}</span></article>)}</div><p className="techBridge"><Workflow size={18} /> HireScoreAI brings the process into one connected hiring workflow.</p></div></section>
}
    ...
    <section className="commandSection aboutCommandSection" id="about">
      <div className="commandContainer aboutCommandGrid">
        <div className="aboutCommandCopy commandReveal">
          ...
          <h2>Built for a faster, clearer and more connected <span>tech hiring journey.</span></h2>
          <p><Link href="/product/hirescore-ai">HireScoreAI</Link> is built for teams that need a faster, clearer and more connected way to hire technical talent.</p>
          <p>The platform connects candidate sourcing, evaluation, hiring actions, pipeline management and analytics across the complete <Link href="/solutions/tech-hiring">tech hiring journey</Link> from requirement to joining.</p>
    ...
    <footer className="commandFooter professionalFooter">
      <div className="commandContainer professionalFooterTop">
        <div className="footerBrandBlock">
          ...
          <p>Source, screen and hire technical talent through one connected HireScoreAI workflow.</p>
